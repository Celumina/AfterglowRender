...
// TODO: Shit, again Assertion failed: i >= 0 && i < Size, file C:\Works\AfterglowRender\Libraries\imgui-1.92.3\imgui.h, line 2211
...
void AfterglowGUI::applyInputCallbacks() {
	...
	// std::unique_lock inputLock{ _inputMutex };
