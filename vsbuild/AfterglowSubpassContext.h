...
public:
	...
	bool bindInputAttachment(render::Domain domain, uint32_t attachmentIndex, const std::string& attachmentName, VkImageLayout imageLayout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
	bool bindInputDepthAttachment(render::Domain domain, uint32_t attachmentIndex, const std::string& attachmentName);
