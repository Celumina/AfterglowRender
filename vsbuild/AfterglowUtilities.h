...
namespace util {
	...
	inline constexpr std::underlying_type_t<EnumType> EnumValue(EnumType e) noexcept;
...
template<typename Type>
inline constexpr std::type_index util::TypeIndex() noexcept {
	return std::type_index(typeid(Type));
}

template<typename EnumType>
inline constexpr std::underlying_type_t<EnumType> util::EnumValue(EnumType e) noexcept {
