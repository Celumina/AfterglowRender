...
float UnderwaterMask(float2 uv, float softness = 0.01, float offset = 0.02) {
	...
	return smoothstep(0.0, softness, max(nearPlaneTerrainHeight.y - nearWorldPos.z + softness + offset, 0.0));
}
